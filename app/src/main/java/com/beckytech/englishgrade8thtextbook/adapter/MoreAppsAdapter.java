...
import com.beckytech.englishgrade8thtextbook.model.MoreAppsModel;
...
public class MoreAppsAdapter extends RecyclerView.Adapter<MoreAppsAdapter.AppsViewHolder> {
    ...
    public AppsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new AppsViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.more_apps_list_item, parent, false));
    }
